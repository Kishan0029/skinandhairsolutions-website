  ...
  head: () => ({
    meta: [
      { title: "Skin Specialist in Belagavi — Dermatology Clinic | SHS" },
      {
        name: "description",
        content:
          "Acne, pigmentation, melasma, psoriasis, eczema, vitiligo, scars and rejuvenation. Premium dermatology treatments in Belagavi by SHS specialists.",
      },
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Healthy skin, beautifully <em className="text-primary not-italic">restored.</em>
          </>
        }
        ...
        <div className="container-x grid gap-12 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-7">
            ...
            <h2 className="mt-4 font-display text-4xl md:text-5xl">
              Quietly confident. Clinically rigorous.
            </h2>
            <p className="mt-5 max-w-xl text-muted-foreground">
              Whether you're managing a long-term condition or seeking elective rejuvenation, you'll
              work with a specialist who genuinely listens — and a clinic equipped to deliver.
            </p>
          </div>
