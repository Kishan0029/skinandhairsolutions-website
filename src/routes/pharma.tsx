    ...
    <>
      ...
      <section className="bg-background pt-10 pb-24">
        <div className="container-x">
          ...
          {/* Trust strip */}
          <FadeIn className="mb-10 grid gap-3 rounded-2xl bg-secondary p-5 text-xs text-foreground/70 sm:grid-cols-3">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {list.map((p, i) => {
              ...
              return (
                <SlideUp key={p.id} delay={i * 0.1}>
                  <article className="group flex h-full flex-col overflow-hidden rounded-3xl border border-foreground/10 bg-card transition-shadow hover:shadow-xl">
